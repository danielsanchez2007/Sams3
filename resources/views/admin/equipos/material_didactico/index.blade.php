...
@section('title', 'Material Didáctico - SAMS')
@section('header-title', 'Material Didáctico')
@section('header-subtitle', 'Traspasar equipo a material didáctico')
    ...
    <div class="pw-card bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
        <div class="flex items-start justify-between gap-3">
            <div>
                ...
                <div class="text-xs text-gray-500">Selecciona un equipo, revisa el preview y traspásalo a material didáctico.</div>
            </div>
        ...
        <form action="{{ route('equipos.traspasar') }}" method="POST" class="mt-4" id="mdForm">
            @csrf
            <input type="hidden" name="equipo_id" id="equipoId">
            <input type="hidden" name="destino" id="destinoInput" value="didactico">
            <input type="hidden" name="from" value="material-didactico">
    ...
    <div class="pw-card bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
        <div class="flex items-start justify-between gap-3">
            <div>
                ...
                <div class="text-xs text-gray-500">Últimos equipos traspasados a material didáctico.</div>
            </div>
        </div>
            ...
            <table class="min-w-full text-sm">
                <thead class="text-xs text-gray-500 uppercase bg-gray-50">
                    <tr>
                        ...
                        <th class="px-3 py-3 text-left">Código MD</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($traspasos as $t)
                        ...
                        <tr>
                            ...
                            <td class="px-3 py-3">
                                <x-codigo-short :codigo="$t->codigo_md" />
                            </td>
        ...
        form.addEventListener('submit', (e) => {
            if (!hiddenId.value) {
                ...
                if (typeof showNotification === 'function') {
                    showNotification('Selecciona un equipo antes de traspasar.', 'warning');
                }
            }
        });
    }
